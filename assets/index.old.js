window.addEventListener("load", function () {
  ...
  function myOnload() {
    ...
    $("myCmdPatissier").addEventListener(
      "click",
      function () {
    ...
    document
      .querySelector(".VideoSymbolContainer")
      .insertAdjacentHTML("beforeend", '<div id="tempLayer"></div>');
  }
  //メニュー表示非表示
  ...
  $("myTrcGM").onclick = function () {
    ...
    var a = document.getElementById(
      "myTxt" + $("myTrcSel2").value.split(" ")[0]
    );
    var b =
      $("myTrcSel2").getElementsByTagName("option")[
        $("myTrcSel2").value.split(" ")[0] - 1
      ];
    if ($("myTrcGM").value == "gothic") {
      $("myTrcGM").value = "mincho";
      b.text = b.text.replace(/mincho/g, "gothic");
      a.style.fontFamily =
        '游ゴシック, SimHei, Arial, "ＭＳ Ｐゴシック", sans-serif';
    } else {
      $("myTrcGM").value = "gothic";
      b.text = b.text.replace(/gothic/g, "mincho");
      a.style.fontFamily =
        '"游明朝体", "Yu Mincho", YuMincho, "Hiragino Kaku Gothic ProN", "Hiragino Kaku Gothic Pro", "メイリオ", Meiryo, "ＭＳ ゴシック", sans-serif';
    }
  };
  /*----------------------------------------------------------------------------------------------------
	[入力]
  ...
  function myBoxIptS(g, p) {
    ...
    //} else {
    h.innerHTML =
      h.innerHTML.slice(0, 8) + "　　　　　info---" + "(" + a.length + ")";
    //}
    ...
    if (g === 0) {
      setTimeout(function () {
        document
          .getElementsByClassName("CommentPostButton")[0]
          .dispatchEvent(
  ...
  $("myTrcDel").onclick = function () {
    ...
    for (var i = 0; i < $("myTrcSel2").length; i++) {
      $("myTrcSel2")[i].text =
        ...
        1 +
        " " +
        $("myTrcSel2")[i].value.split(" ")[1] +
        " " +
        $("myTrcSel2")[i].value.split(" ")[2];
      if ($("myTxt" + (i + 1))) {
    ...
    for (var i = 0; i < b; i++) {
      ...
      if (pls_h != 1 || pls_w != 1) {
        if (j == 0) {
          t.style.top =
            Math.round(
              parseInt(t.style.top.match("([-0-9]+)px")[1]) * pls_h
            ).toFixed(0) + "px";
        }
        t.style.left =
          Math.round(
            parseInt(t.style.left.match("([-0-9]+)px")[1]) * pls_w
          ).toFixed(0) + "px";
        t.style.transform =
          "scale(" +
          (
            Math.round(
              parseFloat(t.style.transform.match(/\d+\.*\d*/g)[0]) *
                pls_h *
                1000
            ) / 1000
          ).toFixed(3) +
          ...
          (
            Math.round(
              parseFloat(t.style.transform.match(/\d+\.*\d*/g)[1]) *
                pls_w *
                1000
            ) / 1000
          ).toFixed(3) +
      ...
      t.style.color =
        "#" +
        parseInt($("myTxtR").value)
          .toString(16)
          .replace(/^[0-9A-Fa-f]$/, "0$&") +
        parseInt($("myTxtG").value)
          .toString(16)
          .replace(/^[0-9A-Fa-f]$/, "0$&") +
        parseInt($("myTxtB").value)
          .toString(16)
          .replace(/^[0-9A-Fa-f]$/, "0$&");
  ...
  $("myFontSizeU").onclick = function () {
    ...
    var v = (
      Math.round((parseFloat($("myFontSize").value) + 0.01) * 100) / 100
    ).toFixed(2);
    $("myFontSize").value = v;
  ...
  $("myTransYU").onclick = function () {
    ...
    var v = (
      Math.round((parseFloat($("myTransY").value) + 0.001) * 1000) / 1000
    ).toFixed(3);
    $("myTransY").value = v;
  ...
  $("myTransXU").onclick = function () {
    ...
    var v = (
      Math.round((parseFloat($("myTransX").value) - 0.001) * 1000) / 1000
    ).toFixed(3);
    $("myTransX").value = v;
  ...
  function myTxtSelect() {
    ...
    $("slider2").style.left =
      a.style.color.match(/\d+/g)[0] - $("slider2").clientWidth / 2 + "px";
    $("myTxtR").value = a.style.color.match(/\d+/g)[0];
    $("slider4").style.left =
      a.style.color.match(/\d+/g)[1] - $("slider4").clientWidth / 2 + "px";
    $("myTxtG").value = a.style.color.match(/\d+/g)[1];
    $("slider6").style.left =
      a.style.color.match(/\d+/g)[2] - $("slider6").clientWidth / 2 + "px";
  ...
  $("myTxtExpOne").onclick = function (Tmode) {
    ...
    if (myLin === true) {
      ...
      u =
        "#" +
        parseInt(
          $("myTxt" + $("myTrcSel2").value.split(" ")[0]).style.color.match(
            /\d+/g
          )[0]
        )
          .toString(16)
  ...
  $("myTrcTxtDisp").onclick = function () {
    ...
    if (a.style.display == "none") {
      a.style.display = "";
      $("myTrcTxtDisp").value = "非表示";
      $("myTrcSel2")[$("myTrcSel2").value.split(" ")[0] - 1].text = $(
        "myTrcSel2"
      )[$("myTrcSel2").value.split(" ")[0] - 1].text.replace(/○/g, "●");
    } else {
  ...
  $("myTrcGrdDisp").onclick = function () {
    if ($("myGrd").style.display === "") {
      ...
      $("myGrd").src =
        myExtUrl + "img/" + $("myTrcSel2").value.split(" ")[1] + ".png";
      $("myGrd").style.display = "";
    }
  };
  /*----------------------------------------------------------------------------------------------------
  ...
  $("myCodeBtn2").onclick = function (evt) {
    if (isColor($("myTxtCode").value)) {
      ...
      $("myTrcSel2")[$("myTrcSel2").value.split(" ")[0] - 1].style.color =
        $("myTxtCode").value;
  ...
  saveLayers = () => {
    ...
    return (
      saveElementsLayer.innerHTML +
      "|--定義--|" +
      saveElements.innerHTML +
      "|--定義--|" +
  ...
  loadLayers = (data) => {
    ...
    for (
      var i = 0;
      i < document.getElementById("myTrcSel2").childNodes.length;
      i++
    ) {
      document.getElementById("tempLayer").childNodes[i].value =
        restoreValueList[i].value;
      document
        .getElementById("tempLayer")
        .childNodes[i].addEventListener("focus", myTxtSelect, false);
      document.getElementById("myTrcSel2").childNodes[i].selected =
        restoreValueList[i].selected;
    }
  };
  ...
  myLayerSaveFile.onclick = function () {
    ...
    a.href = URL.createObjectURL(
      new Blob([save_content], { type: "text/plain" })
    );
    a.download = address;
    a.style.display = "none";
  ...
  myLayerLoadFile.onclick = function () {
    ...
    document
      .getElementById("layerloadfileelement")
  ...
  godMode.onclick = function () {
    document.querySelector(".nico-CommonHeaderRoot").querySelector("img").src =
      "https://secure-dcdn.cdn.nimg.jp/nicoaccount/usericon/35/358504.jpg";
    document
      .querySelector(".nico-CommonHeaderRoot")
      .querySelector("span").innerText = "HDA";
  };

  cssAdvancedSettings.onclick = function () {
    document.querySelector("#cssAdvancedSettings").textContent.includes("▶")
      ? (document.querySelector("#cssAdvancedSettings").textContent = document
          .querySelector("#cssAdvancedSettings")
          .textContent.replace("▶", "▼"))
      : (document.querySelector("#cssAdvancedSettings").textContent = document
          .querySelector("#cssAdvancedSettings")
          .textContent.replace("▼", "▶"));
