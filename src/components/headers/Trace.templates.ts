...
const Templates: TLayerTemplates = {
  ...
  tm27: {
    ...
    pos: "naka",
    posList: ["naka"],
    text: "Tokome medium 27 流",
    value: "Tokome_medium_naka_full_gothic_W40_L27_流",
    areaWidth: 652,
    width: 47,
    height: 27,
    critical: false,
    ...
    left: 11,
    scale: { x: 0.948, y: 1.007 },
    size: [{ font: 13.85, line: 14, lineCount: 27 }],
  },
  ts38: {
    id: "ts38",
    commands: ["small", "full"],
